...
class WindowDragger(QFrame, object):
    ...
    def __init__(self, parent=None, on_close=None):
        ...
        self._button_minimized.setIcon(tpQtLib.resource.icon('minimize'))
        ...
        self._button_maximized.setIcon(tpQtLib.resource.icon('maximize'))
        ...
        self._button_restored.setIcon(tpQtLib.resource.icon('restore'))
        ...
        button_closed.setIcon(tpQtLib.resource.icon('close'))
