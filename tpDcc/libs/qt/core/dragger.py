...
class WindowDragger(QFrame, object):
    ...
    DRAGGER_ICON_SIZE = 22

    def __init__(self, window=None, parent=None, show_title=True):
        super(WindowDragger, self).__init__(parent=parent or window)
    ...
    def set_logo_highlight(self, highlight_color=None):
        if highlight_color:
            pass
