...
class ItemWidget(QTreeWidgetItem, object):
    """
...
# class LibraryGroupItem(ItemWidget, object):
#     """
...
class LibraryFolderItem(ItemWidget, object):
...
class BaseItem(ItemWidget, object):
